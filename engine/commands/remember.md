...
**Governance:** This command does not modify the planning doc or task status. See `engine/rules/context-preservation.md` Rule 6 for scope; `docs/ai/Effective_Execution_Manifesto.md` for the Utility Belt.

**PRIME DIRECTIVE:** Use this utility to store First-Principles, Enablement Architecture rules, and strictly defined User's Requirements into the `@ai-devkit/memory` MCP server. Do not store generic, low-level coding advice.
