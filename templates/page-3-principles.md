# Template: Page 3 — Principles

*Page type: Principles (Phase C. Organise Information). Same canonical questions as Page 0; rows = principles per tree map § 6 Pages per Topic. Use for any (chapter, topic, page=3).*
